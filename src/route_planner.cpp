...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    // https://riptutorial.com/cplusplus/example/5940/sorting-sequence-containers-using-lambda-expressions--cplusplus11-
    std::sort(this->open_list.begin(), this->open_list.end(), [](const auto &nodeA, const auto &nodeB){
